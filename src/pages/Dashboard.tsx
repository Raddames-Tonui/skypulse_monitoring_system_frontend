...
import { useServiceStatusSSE, useSystemHealthSSE } from "@/hooks/useSSE";
import type { Service } from "@/utils/types";
import SSEHealth from "./SSEHealthProps";

export default function Dashboard() {
  const navigate = useNavigate();

  const sseData = useServiceStatusSSE();
  const systemHealthData = useSystemHealthSSE();
    ...
    <div>
      ...
      <div className="dashboard-wrapper">
        <div className="status-sidebar-wrapper">
          <StatusSidebar data={sseData} systemHealth={systemHealthData} />
        </div>
