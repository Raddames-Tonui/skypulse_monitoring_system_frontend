...
import { getMembersColumns, getServicesColumns } from "@/pages/groups/data-access/schemas.tsx";
...
export default function SingleContactGroupPage() {
    ...
    const { data: servicesData, isLoading: loadingServices } = useGetContactGroupServices(uuid);
    ...
    const membersCols = getMembersColumns(removeMemberMutation, setPrimaryMutation, refetch);
    const servicesCols = getServicesColumns(removeServiceMutation, refetch);
