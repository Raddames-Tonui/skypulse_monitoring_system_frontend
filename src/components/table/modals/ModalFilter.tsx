    ...
    <Modal
      ...
      body={
        <div>
          ...
          <button className="table-modal-cancel" onClick={addRule}>
            Add Filter
          </button>
        </div>
      }
      footer={
        <div>
          <button className="table-modal-cancel" onClick={reset}>
            Reset
          </button>
          <button className="table-modal-close-btn" onClick={handleSubmit}>
            Apply
          </button>
        </div>
      }
